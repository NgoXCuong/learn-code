...
const EmotionAnalysis = () => {
  return (
    <div className="flex flex-col h-full">
      ...
      {/* Khung icon + nội dung */}
      <div className="flex flex-row items-center p-2 rounded-sm flex-1 bg-yellow-100 dark:bg-yellow-900 text-yellow-900 dark:text-yellow-100 overflow-auto gap-4">
        {/* Icon bên trái */}

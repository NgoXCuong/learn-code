          ...
          <div className="flex flex-col  sm:flex-row sm:items-start sm:justify-between gap-3 px-4 sm:px-6 md:px-14 lg:px-20">
            <div className="flex-1">
              ...
              <div className="flex flex-wrap items-center gap-2 sm:gap-3 text-xs sm:text-sm">
                ...
                >
                  ...
                  <span className="font-normal">30 phút</span>
                </span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className={`flex items-center gap-1 px-3 py-1 rounded-sm text-sm font-medium transition-all ${
                  !prevExercise
                    ? isDark
              ...
              <div
                className={`px-1 py-1 text-xs sm:text-sm font-medium ${
                  isDark ? "text-gray-400" : "text-gray-600"
                }`}
              >

    ...
    <div className="hidden lg:flex justify-center items-center">
      <div className="relative w-full max-w-lg">
        ...
        <div className="relative">
          <div className="relative w-full h-80 rounded-lg bg-slate-900/90 backdrop-blur-md border-2 border-cyan-400/60 shadow-[0_0_50px_rgba(34,211,238,0.5),inset_0_0_30px_rgba(34,211,238,0.2)] overflow-hidden">
            {/* TOP BAR */}
            <div className="absolute top-0 left-0 right-0 h-8 bg-linear-to-b from-cyan-500/20 to-transparent border-b border-cyan-400/30 flex items-center justify-between px-4">
